...
class Happilyunmarried_Valentines_Adminhtml_BannerController extends Mage_Adminhtml_Controller_Action
{
    ...
    public function postAction() {
		...
		try {
            ...
            exit;
            // Create query
			$query = "UPDATE valentines_banner SET  banner_image=".$image_banner." WHERE banner_id = 1";
