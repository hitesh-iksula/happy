...
class Iksula_Storelocator_Adminhtml_CityController extends Mage_Adminhtml_Controller_Action
{
		protected function _initAction()
		{
				$this->loadLayout()->_setActiveMenu("storelocator/city")->_addBreadcrumb(Mage::helper("adminhtml")->__("City  Manager"),Mage::helper("adminhtml")->__("City Manager"));
				return $this;
		}
		...
		{			    
				...
				if ($model->getId()) {
					...
					$this->loadLayout();
					$this->_setActiveMenu("storelocator/city");
					...
					$this->_addContent($this->getLayout()->createBlock("storelocator/adminhtml_city_edit"))->_addLeft($this->getLayout()->createBlock("storelocator/adminhtml_city_edit_tabs"));
					$this->renderLayout();
				} 
				else {
		...
		{
			$fileName   = 'city.csv';
			$grid       = $this->getLayout()->createBlock('storelocator/adminhtml_city_grid');
