 ...
 *
 */
class Iksula_Explore_ContactusController extends Mage_Core_Controller_Front_Action {
        ...
        if ( $post ) {
            ...
            try {
                ...
                if ($error) {
                    ...
                    $platform   = (string) $this->getRequest()->getPost('platform');
                    ...
                    if($userMail == $email){
                        ...
                        //echo "okk";exit;
                          ...
                          $collection->setSource('Contact Us form');
