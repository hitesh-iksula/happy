...
class Iksula_Explore_Block_Adminhtml_Occasion_Edit_Tab_Form extends Mage_Adminhtml_Block_Widget_Form
{
	...
	{		
		...
		$this->setForm($form);
		$fieldset = $form->addFieldSet('explore_form', array('legend'=>Mage::helper('explore')->__('Occasion Information')));
		
		$fieldset->addField('occasion_name', 'text', array(
			'label' => Mage::helper('explore')->__('Occasion'),
			'required' => true,
			'name' => 'occasion_name',
		));
		
		$fieldset->addField('occasion_logo_1', 'image', array(
			'label' => Mage::helper('explore')->__('Logo (Active)'),
			'required' => false,
			'name' => 'occasion_logo_1',
		));
		
		$fieldset->addField('occasion_logo_2', 'image', array(
			'label' => Mage::helper('explore')->__('Logo (Inactive)'),
			'required' => false,
			'name' => 'occasion_logo_2',
		));
