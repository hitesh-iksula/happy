...
class FlipKart_PayZippy_Block_Form extends Mage_Payment_Block_Form {
    ...
    protected function _construct()
    {
        ...
        $this->setTemplate('payzippy/form.phtml')->setRedirectMessage(
                Mage::helper('payzippy')->__('Now pay on <span>Happily Unmarried</span> and your other favorite websites without typing any card details! Just save these details once with <span>PayZippy</span>.')
            );
    }
